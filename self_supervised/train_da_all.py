...
train_loader = torch.utils.data.DataLoader(md_train, batch_size=32, shuffle=True, num_workers=12)
load=False
...
for epoch in range(total_epochs):
    ...
    if epoch%50==0:
        save_path = './checkpoints/' + 'all' + '/self_sup/net_ss{}.path'.format(epoch//50)
